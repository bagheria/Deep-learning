# gensim Word2Vec with TensorFlow and Keras
# https://adventuresinmachinelearning.com/gensim-word2vec-tutorial/
# https://github.com/adventuresinML/adventures-in-ml-code/blob/master/gensim_word2vec.py
...
def keras_model(embedding_matrix, wv):
    ...
    similarity = dot([embedded_a, embedded_b], axes=2)
